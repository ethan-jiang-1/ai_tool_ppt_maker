...
完整管线在 `04_production_pipeline/` 中详细展开。以下是 style master 相关的摘要：
...
> **Next**: 你已完成方法论。复制 `template-visual-style.md` 到你的项目，生成你的 visual style master，迭代，锁定，然后进入 `04_production_pipeline/` 和 `06_reference_scripts/`。
