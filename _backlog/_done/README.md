...
> 最后更新: 2026-08-14 | `_backlog/_done/` — 所有已完成内容的归档根目录。
...
_（已修复 bug：BUG-001…037、040…063、065、066；BUG-038、039 悬挂。已关闭 plan：CLS-001…034。每次搬迁按 `../README.md` 的 ritual 更新对应计数与 Next ID。）_
