...
> 最后更新: 2026-07-23 | `_backlog/_done/` — 所有已完成内容的归档根目录。
...
_（已修复 bug：BUG-001…013、BUG-016…033；BUG-014/015/034 仍活跃。已关闭 plan：CLS-001…011。每次搬迁按 `../README.md` 的 ritual 更新对应计数与 Next ID。）_
