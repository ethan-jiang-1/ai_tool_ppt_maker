...
> 最后更新: 2026-08-10 | `_backlog/_done/` — 所有已完成内容的归档根目录。
...
| 归档目录 | 数量 | Next ID |
|---------|------|---------|
| `_fixed_bugs/` | 61 | BUG-067 |
| `_suspened_bugs/` | 2 | — |
| `_done_todos/` | 1 | DONE-002 |
| `_closed_plans/` | 24 | CLS-025 |

_（已修复 bug：BUG-001…037、040…063、065；BUG-038、039 悬挂。已关闭 plan：CLS-001…024。每次搬迁按 `../README.md` 的 ritual 更新对应计数与 Next ID。）_
