...
> 最后更新: 2026-09-03 | `_backlog/_done/` — 所有已完成内容的归档根目录。
...
| 归档目录 | 数量 | Next ID |
|---------|------|---------|
| `_fixed_bugs/` | 79 | BUG-094 |
| `_suspended_bugs/` | 13 | — |
| `_suspended_plans/` | 2 | — |
| `_done_todos/` | 2 | DONE-003 |
| `_closed_plans/` | 47 | CLS-048 |

_（已修复 bug：BUG-001…037、040…063、065、066、067、068、069、070、071、072、073、074、077、078、079、081、085、088、090、093；悬挂：BUG-038、039 与 2026-08-20 triage wontfix 的 075/076/080/082/083/084/086/087/089/091/092。已关闭 plan：CLS-001…047。每次搬迁按 `../README.md` 的 ritual 更新对应计数与 Next ID。）_
