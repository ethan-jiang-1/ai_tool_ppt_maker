...
> 最后更新: 2026-07-28 | `_backlog/_done/` — 所有已完成内容的归档根目录。
...
| `_closed_plans/` | 13 | CLS-014 |

_（已修复 bug：BUG-001…014、BUG-016…034；BUG-015 仍活跃。已关闭 plan：CLS-001…013。每次搬迁按 `../README.md` 的 ritual 更新对应计数与 Next ID。）_
