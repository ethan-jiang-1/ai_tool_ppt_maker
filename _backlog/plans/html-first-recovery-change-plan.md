...
- [x] **Change 1 - `make-html-production-guided-and-recoverable`**: **已完成并归档**。
  ...
  `266a7db`。
- [x] **Change 2 - `complete-markerless-html-migration`**: **已完成并归档**。
  `35/35` tasks、focused migration/parser/topology/contract tests、`npm test`、
  `npm run test:e2e`（6 files / 41 tests）、strict OpenSpec validation 与
