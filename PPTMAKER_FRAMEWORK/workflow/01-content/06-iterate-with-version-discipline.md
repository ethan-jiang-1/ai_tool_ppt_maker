...
← [04](05-create-content-assets.md) | [README](README.md)
...
| CONCEPT / visible copy 重写 | 单张 slide + content review/overflow/local composition | 低-中，本地 |
| family / typed body / fallback 改写 | 单张 slide + recipe/page visual evidence | 中，本地 |
