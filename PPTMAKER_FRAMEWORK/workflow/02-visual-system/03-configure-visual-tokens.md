...
The HTML renderer consumes the validated `html_first` projection. A style master is not a prerequisite for a new deck. Optional Image2 refinement is unavailable in this version; markerless historical decks use `reference/legacy-image2-first-maintenance.md`.
