...
Visual approval is based on real local HTML compositor output and contact-sheet evidence. Modern Image2 refinement is unavailable; markerless historical style-master work uses `../../reference/legacy-image2-first-maintenance.md`.
