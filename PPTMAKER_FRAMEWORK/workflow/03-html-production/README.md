...
Preview may run while content/visual reviews are pending. Stage 4 requires current authoritative review evidence. All outputs are rebuildable under `_generated/html_production/`; do not edit them. Markerless decks route to `../../reference/legacy-image2-first-maintenance.md` and keep their isolated legacy stages.
