...
The HTML branch accepts no provider/browser/package/path overrides. First-class whole-page Image2 retains `stage2_generate_images.mjs` and `stage3_lock_headers.mjs` behind its branch adapter; those scripts are not HTML prerequisites.
