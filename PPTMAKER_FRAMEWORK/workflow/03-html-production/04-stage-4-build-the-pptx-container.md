...
Publish assembly schema v2 atomically with ordered IDs, final-slide fingerprints/SHAs, PPTX SHA, delivery digest, and current HTML reset ID. First-class whole-page Image2 uses its own artifact adapter and cannot bypass an HTML gate through artifact mode.
