...
Image2 checks and live probes are optional legacy diagnostics only. Use them after a explicit whole-page deck has routed to `playbook/create-deck.md`; a successful probe is not page-generation authorization.
