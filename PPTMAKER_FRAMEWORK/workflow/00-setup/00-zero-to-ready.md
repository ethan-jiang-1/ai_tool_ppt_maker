...
export OPENAI_BASE_URL="https://你的-relay/v1"   # 可选；留空使用已安装 skill 的默认 endpoint
```
...
> **准备好了？** 回到 [workflow/00-setup/QUICK_START.md](../workflow/00-setup/QUICK_START.md)，或者直接把上面的 conversation starter 贴进你的 agent。
