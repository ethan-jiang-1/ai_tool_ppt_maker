...
/** PPTMAKER_FRAMEWORK/ — parent of 06_reference_scripts/ */
export const FRAMEWORK_DIR = resolve(__dirname, "..");

/** 06_reference_scripts/ — where the per-stage scripts live */
...
export function validateRunDir(runDir, requireReady = true) {
  ...
  if (violations.length > 0) {
    ...
    console.log("  Canonical structure:  node PPTMAKER_FRAMEWORK/06_reference_scripts/bundle_layout.mjs");
    return false;
  }
  return true;
}
