...
VISUAL TYPE 关联到视觉系统中的 Slide Type Template（参见 [01_visual_style_master](../01_visual_style_master/)）。如果你在 01 的视觉系统中定义了 8 种 slide type template，那么每张 slide 的 VISUAL TYPE 必须对应其中之一。
...
这是本方法论和接下来的 [03_image_prompts](../03_image_prompts/)（Prompt Engineering 方法论）交叉最深的层。这里聚焦于 **content-driven prompt design**——怎么把你的内容概念翻译成精确的视觉指令。
...
更多关于 IMAGE PROMPT 的底层技巧，参见 [03_image_prompts](../03_image_prompts/)。
