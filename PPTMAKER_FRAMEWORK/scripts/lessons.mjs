...
import "./lib/cli_bootstrap.mjs?entry=lessons.mjs";
import { CLI_ERROR_CODES, emitCliError } from "./lib/cli_error.mjs";
...
Examples:
  node PPTMAKER_FRAMEWORK/scripts/lessons.mjs list deck_x/3_versions/v1
  node PPTMAKER_FRAMEWORK/scripts/lessons.mjs add deck_x/3_versions/v1 --title "font-fix"
  node PPTMAKER_FRAMEWORK/scripts/lessons.mjs check deck_x/3_versions/v1
  node PPTMAKER_FRAMEWORK/scripts/lessons.mjs search deck_x/3_versions/v1 vendor`);
}
