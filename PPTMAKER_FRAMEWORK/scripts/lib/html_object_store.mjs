...
import { GENERATED_SUBDIR, GEN_HTML_FINAL_SLIDES_SUBDIR, GEN_HTML_PAGES_SUBDIR, GEN_HTML_PREVIEW_SUBDIR, GEN_HTML_PRODUCTION_SUBDIR, deckRoot } from '../bundle_layout.mjs';
