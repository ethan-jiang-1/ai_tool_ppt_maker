# Framework Framed runtime fonts

This is the sole canonical distribution root for the framework's required Framed-runtime WOFF2 assets, CSS snapshots, inventory, provenance, copyright notices, and licenses.
...
This contract is separate from Page Authority finalization ownership. `@napi-rs/canvas` keeps its existing OTF/TTF or supported system-font fallback behavior; these WOFF2 files do not replace or alter that canvas contract.
