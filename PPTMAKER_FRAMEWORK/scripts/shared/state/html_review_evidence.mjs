...
import { deckRoot, METADATA_FILE } from '../run-bundle/bundle_layout.mjs';
import {
...
} from '../../03-html-production/internal/html_object_store.mjs';
import { HTML_FIRST_PIPELINE, probeProductionMarker, validateAndBuildHtmlFirstPlan } from '../../03-html-production/internal/html_slide_contract.mjs';
...
import { buildHtmlReviewPlan } from '../../03-html-production/internal/html_preview.mjs';
import {
  assemblyReceiptPath,
  notesReceiptPath,
  sha256File,
...
import { resolveHtmlFinalSlideArtifacts } from '../identity/render_artifacts.mjs';
