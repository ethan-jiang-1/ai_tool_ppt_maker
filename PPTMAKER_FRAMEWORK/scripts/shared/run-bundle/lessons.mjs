...
import { CLI_ERROR_CODES, emitCliError } from "../cli/cli_error.mjs";
...
Examples:
  node PPTMAKER_FRAMEWORK/scripts/shared/run-bundle/lessons.mjs list deck_x/3_versions/v1
  node PPTMAKER_FRAMEWORK/scripts/shared/run-bundle/lessons.mjs add deck_x/3_versions/v1 --title "font-fix"
  node PPTMAKER_FRAMEWORK/scripts/shared/run-bundle/lessons.mjs check deck_x/3_versions/v1
  node PPTMAKER_FRAMEWORK/scripts/shared/run-bundle/lessons.mjs search deck_x/3_versions/v1 vendor`);
}
