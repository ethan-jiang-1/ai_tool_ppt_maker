...
import { HTML_FONT_ROOT, parseUnicodeRanges } from '../../00-setup/internal/html_fonts.mjs';
import { validateHtmlAssetBytes } from '../../02-visual-system/internal/html_asset_catalog.mjs';
import { rewriteSvgInstanceIds } from '../../02-visual-system/internal/html_chart_svg.mjs';
import { renderEchartsSsrSvgSync, validateEchartsSvg } from '../../02-visual-system/internal/html_chart_svg.mjs';
import { validateHtmlComponentProjection } from '../../02-visual-system/internal/html_component_registry.mjs';
import { discoverNpmPackages } from '../../00-setup/env-check.mjs';
import { resolveSlideBindings } from '../../01-content/internal/slide_ids.mjs';
import { inspectHtmlRuntime } from '../../00-setup/internal/html_runtime.mjs';
...
import { finalSlideFingerprintV1 } from '../../shared/identity/render_artifacts.mjs';
import { inspectHtmlReviewReadiness } from '../../shared/state/html_review_evidence.mjs';
import { SCRATCH_SUBDIR } from '../../shared/run-bundle/bundle_layout.mjs';
