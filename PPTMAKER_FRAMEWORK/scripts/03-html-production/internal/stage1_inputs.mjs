...
import { normalizeSpokenKey } from "../../01-content/index.mjs";
...
const STAGE1_EXECUTABLE = "PPTMAKER_FRAMEWORK/scripts/03-html-production/stage1_build_inputs.mjs";
    ...
    emitCliError({
        ...
        diagnostic: {
            ...
            next: createCliNext("fix_arguments", {
                invocation: { program: "node", args: [STAGE1_EXECUTABLE, "--validate", "--spec", "slide-specifications.md"] },
...
export function runStage1Inputs(argv = process.argv.slice(2), { executablePath = STAGE1_EXECUTABLE } = {}) {
    ...
    if (args.input.length === 0) {
        ...
        emitCliError({ code: CLI_ERROR_CODES.USAGE, message: "Stage 1 requires at least one --spec source file.", hint: "Pass one or more markdown slide specification files.", where: "stage1_build_inputs.arguments", diagnostic: { version: 1, category: "usage", stage: "stage1", operation: "parse-arguments", next: createCliNext("fix_arguments", { invocation: { program: "node", args: [executablePath, "--spec", "slide-specifications.md", "--validate"] }, default: "Pass at least one --spec path, then rerun Stage 1." }) } });
        process.exit(1);
    }
