 ...
 * @returns {Promise<{slideCount: number, notesInjected: number}>}
 */
export async function runStage5Cli(argv = process.argv, { executablePath = "PPTMAKER_FRAMEWORK/scripts/03-html-production/stage5_inject_notes.mjs" } = {}) {
        ...
        emitCliError({
          ...
          diagnostic: diagnostic || {
            ...
            next: createCliNext("repair_prerequisite", {
              ...
              invocation: { program: "node", args: [executablePath, "--pptx", opts.pptx, "--input", ...inputs] },
