...
export { HTML_FIRST_PIPELINE, probeProductionMarker } from "../../shared/run-bundle/production_marker.mjs";
...
const GEOMETRY_CONTRACT_PATH = resolve(MODULE_DIR, "..", "..", "contracts", "html-family-geometry-v1.json");
...
function buildReceipts({ runDir, sourcePath, palettePath, assetCatalog, preflight }) {
  ...
  const records = [
    ...
    receipt("framework", frameworkPath(GEOMETRY_CONTRACT_PATH), readFileSync(GEOMETRY_CONTRACT_PATH)),
  ];
