---
title: Page Image Visual System
...
versioned registry. Framed protects its local header zone while the Provider renders
...
but does not infer it. If any package document is missing, malformed, or has an
invalid sibling binding, repair that named source document and rerun the same
planning checkpoint. This is a source/configuration hard-stop, not a new
Controller node, human confirmation, or review gate.
