...
export const COMMAND_CONTRACTS = Object.freeze({
  ...
  probe: { exitCodes: DEFAULT_EXIT_CODES, stdout: "connectivity report", stderr: DEFAULT_STDERR, note: "success is confirmed Call Shape connectivity only, not readiness or authorization" },
