...
bounded owner-issued hard-stop for a v2, partial, hybrid, missing, or corrupt
...
| V2, partial, hybrid, or mismatched pair | direct source/state prerequisites | unsupported-protocol/export owner | 0 / 0 |
