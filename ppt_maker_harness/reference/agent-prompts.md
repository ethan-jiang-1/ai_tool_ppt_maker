...
Reference the metaphor catalog in ppt_maker_harness/workflow/01-content/presets/metaphor-catalog.md
...
Reference each preset's README in ppt_maker_harness/workflow/02-visual-system/presets/ for full details.
```
