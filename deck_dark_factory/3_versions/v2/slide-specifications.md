...
<!-- regeneration epoch 3: text-prominent provider prompt -->
...
**SUBTITLE**: Rebuilding teams, platforms, and orgs around agents
...
motifs: [gear-cogs]
negative_constraints: [no-readable-text, no-labels, no-logo, no-watermark]
```
...
**KICKER**: 2009 DÉJÀ VU
**TITLE**: Not ready yet, not impossible
...
**TITLE**: Commodity harness, org edge.
...
**TITLE**: Coder to conductor: a new craft
...
**TITLE**: Stop fixing the code. Fix the system.
...
**KICKER**: TEAM RITUALS
**TITLE**: Retro: fix the system. Planning: split work.
...
**KICKER**: WHAT MATTERS
**TITLE**: Two metrics for agentic productivity
...
**TITLE**: Show the cost. Optimize, don't limit.
...
**TITLE**: Titles lie. The interview tells.
...
**KICKER**: HONEST RISK
**TITLE**: A dim factory: pick your risk per feature
...
**KICKER**: THE TAKEAWAY
**TITLE**: From continuous delivery to learning
