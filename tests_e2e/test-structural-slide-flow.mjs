...
import { makeContactSheet } from "../PPTMAKER_FRAMEWORK/scripts/make_contact_sheet.mjs";
import {
...
describe("stable slide identity structural E2E", () => {
  ...
  it("keeps markerless legacy IDs and distinguishes proven from merely located bytes", async () => {
    ...
    try {
      ...
      const { createVersion } = await import("../PPTMAKER_FRAMEWORK/scripts/bundle_layout.mjs");
