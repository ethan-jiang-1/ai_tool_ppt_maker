...
const stage2 = 'PPTMAKER_FRAMEWORK/scripts/03-html-production/stage2_render_html.mjs';
const stage3 = 'PPTMAKER_FRAMEWORK/scripts/03-html-production/stage3_compose_slides.mjs';
