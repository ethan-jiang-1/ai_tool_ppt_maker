...
import {
  ...
  writeHtmlObject,
} from '../../PPTMAKER_FRAMEWORK/scripts/03-html-production/internal/html_object_store.mjs';
import { finalSlideFingerprintV1 } from '../../PPTMAKER_FRAMEWORK/scripts/shared/identity/render_artifacts.mjs';
