...
describe('HTML runtime static smoke contract', () => {
  ...
  it('contains no installer, runtime download, or system-browser fallback path', () => {
    const runtime = readFileSync(join(process.cwd(), 'PPTMAKER_FRAMEWORK', 'scripts', '00-setup', 'internal', 'html_runtime.mjs'), 'utf8');
    const fonts = readFileSync(join(process.cwd(), 'PPTMAKER_FRAMEWORK', 'scripts', '00-setup', 'internal', 'html_fonts.mjs'), 'utf8');
