...
- **WHEN** a explicit whole-page legacy run has current verified Stage-3 final-slide evidence
...
- **WHEN** a explicit whole-page deck has a current schema-v1 assembly receipt from before the change
