...
- **AND** the mixed-ID target remains explicit whole-page rather than falsely declaring every ID mnemonic-native
...
- **WHEN** a explicit whole-page target inserts an ID with no verified raw render
