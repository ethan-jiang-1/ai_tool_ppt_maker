...
missing raw acceptance, stale evidence, or provider-bound work without explicit authorization are
hard-stops because they protect pixel ownership and evidence integrity. Review remains a human
semantic decision; the Agent may perform only the mechanical, receipt-bound steps. The direct resolver,
