...
- [ ] 1.1 `mkdir tests_e2e/`
- [ ] 1.2 创建 `tests_e2e/test-state-machine.mjs` — 7 个 describe block:
...
- [ ] 1.3 `package.json` 加 `"test:e2e": "vitest run --config vitest.e2e.config.mjs"`
- [ ] 1.4 创建 `vitest.e2e.config.mjs` (include: tests_e2e/)

## 2. 验证

- [ ] 2.1 `npm run test:e2e` 全部通过
- [ ] 2.2 `npm test` 不受影响 (25/25)
