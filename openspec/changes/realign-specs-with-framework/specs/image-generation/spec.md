...
Whole-page Image2 generation receipts and produced artifact records SHALL identify `whole-page-image2-v1` and current whole-page producers. They SHALL not emit or accept a retired lineage value.
