...
Notes injection SHALL accept a whole-page root assembly only when it declares `whole-page-image2-v1`, and SHALL publish the same pipeline in its notes receipt.
