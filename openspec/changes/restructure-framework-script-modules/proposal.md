...
- Mirror the same ownership vocabulary in `tests/` and `tests_e2e/`; make unit/integration tests exercise Phase interfaces, assign E2E journeys to their final owning Phase, and keep helpers free of production business rules.
