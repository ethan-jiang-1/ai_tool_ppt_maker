...
- 让 Framed raw contract 传递性绑定 render profile；profile 漂移通过既有 owner 使 raw plan、authorization、review、accepted raw、final 与 delivery derivatives 陈旧。合法 Text Frame-only refresh 继续 provider-free，notes-only refresh 继续 browser-free。
