...
**Migration**: Inspection projects only v2 prerequisites; non-v2 input receives the bounded unsupported-protocol hard-stop.
...
**Migration**: Workflow inspection has one v2 projection plus a non-mutating unsupported-protocol hard-stop.
