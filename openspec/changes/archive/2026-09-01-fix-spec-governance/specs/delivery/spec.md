...
Delivery covers final projection, PPTX assembly, speaker-note injection, and delivery review for the current Page Image Workflow. It unifies the former `notes-injection` and `pptx-assembly` capabilities into one delivery owner for `05-delivery/`.
