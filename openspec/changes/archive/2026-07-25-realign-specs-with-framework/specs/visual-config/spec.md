...
**Reason**: The preset-to-projected-candidate palette conversion and its migration scratch owner are retired.

**Migration**: A production-mode transition accepts explicitly authored target visual configuration; it does not construct or stage a palette from source whole-page controls.
