...
**Reason**: Its v2 protocol identity and text-free Framed assumptions are
retired.

**Migration**: Current finalization starts from a replacement Page Image
Workflow receipt and Complete Page Review.

### Requirement: Framed compositor is a private evidence-bound adapter

**Reason**: Its underlay-only contract does not describe the corrected Framed
page model.

**Migration**: The retained local renderer composes only the closed header over
a provider-composed page.

### Requirement: TARGET workflow adapters publish one common final-slide manifest

**Reason**: The v2 final manifest identity and native-underlay rule are
retired.

**Migration**: Delivery consumes `page-image-final-slide-manifest-v1`.

### Requirement: Image production resolves only selected v2 workflow owners

**Reason**: v2 owners are not current production routes.

**Migration**: Resolve only the replacement Page Image Workflow pair.

### Requirement: Framed Pilot preview reuses the final composition contract

**Reason**: The old Pilot represents a text-free underlay rather than a
complete provider page.

**Migration**: Current Pilot uses the corresponding Complete Page Review
representation without acceptance authority.

### Requirement: Pilot evidence preserves selected-workflow isolation

**Reason**: Its v2-specific review contribution schemas are retired.

**Migration**: Current workflow-specific evidence is defined by the
replacement Page Image Workflow contract.
