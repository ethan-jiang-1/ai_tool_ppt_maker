...
**Reason**: The accepted requirement includes migration scenarios for historical
storage forms. Current layout owners reject undeclared inputs before artifact
inspection or mutation.
**Migration**: Replace it with the current short-path ownership requirement
below.
