...
**Reason**: The accepted requirement includes a named historical-source
scenario. The replacement describes only current source validation and ordinary
undeclared-value failure.
