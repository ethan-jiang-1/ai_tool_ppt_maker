...
**Reason**: Naming and specially classifying a historical lineage is a
compatibility reader, which the clean cutover prohibits.
**Migration**: State uses ordinary exact-current validation and rejects every
undeclared marker before state repair, provider work, or lifecycle projection.
