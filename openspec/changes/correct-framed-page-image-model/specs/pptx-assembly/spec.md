...
**Reason**: It accepts the retired v2 final-manifest lineage.

**Migration**: Assemble only `page-image-final-slide-manifest-v1`.

### Requirement: Page Authority PPTX slides project their current ordinal

**Reason**: It identifies order with the retired Page Authority target.

**Migration**: Derive the annotation from the replacement manifest order.
