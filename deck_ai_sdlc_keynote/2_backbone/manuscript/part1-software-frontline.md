...
### S1.9: Block vs Cloudflare — 两种裁法的故事

**KICKER**: 两家高科技公司，同一个季度裁员。一家砍了 40% 所有人——被分析师集体判定为"AI 是包装"。另一家精准换掉"量度者"、同时扩招"建造者"——被市场解读为结构性重组。

**CLAIM**: Block 和 Cloudflare 代表了 AI 时代组织变革的两种模式：一刀切 vs 精准置换。区分标准不是 AI 用没用——是裁员前公司到底出了什么问题、裁的是哪个类型的人。

**BODY**:

**Block（Square 母公司）**：2026 年 2 月裁员 40%（~4,000 人），CEO Jack Dorsey 发布"From Hierarchy to Intelligence"宣言，声称 AI 使工程师效率 +40%。废除管理层级，三种角色（IC/DRI/Player-Coach）取代传统职级。股价涨了 20%。

但独立分析师一致判定：**AI 是叙事包装，成本削减是主因。** 为什么？三个检验维度全中：

1. 裁员前员工从 ~3,800 激增到 ~13,000（237%）——Dorsey 后来承认"招太多了"
2. 股价已跌了 70-80%
3. 存在 CFPB 处罚等运营合规问题

Dorsey 一边裁 4,000 人，一边一个月内又召回部分被裁员工——Klarna 回旋镖正在重演（Klarna 18 个月前裁 23%，现在后悔，55% 企业后悔 AI 相关裁员）。

**Cloudflare**：同季度裁员 20%（~1,100 人），16 年历史首次。但 CEO Matthew Prince 的说法完全不同：**"Displacement, not reduction."** 裁的是"量度者"（合规、财务、法务、中层管理），同时创纪录扩招工程师。

Prince 的 Builder/Seller/Measurer 框架：
...
关键区别：Cloudflare 不是在"用 AI 替代人"——是在"换一种人替代另一种人"。股价跌了 14-24%（市场仍有疑虑），但 9 家独立分析师一致认为这是结构性重组，非财务困境。

**两条路的对比**：

| | Block | Cloudflare |
|------|------|------|
| 裁员规模 | 40%（~4,000 人） | 20%（~1,100 人） |
| 模式 | 一刀切均匀削减 | 按角色精准置换 |
| 独立判断 | AI 是包装，成本是主因 | 结构性重组 |
| 是否召回 | 一个月内召回部分 | 未报告 |
| 可复制性 | 低（数字原生平台） | 高（Measurer 框架通用） |
